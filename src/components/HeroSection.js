...
const HeroSection = ({ profileImageUrl }) => (
  <div className="relative mx-auto max-w-full h-[500px] bg-gradient-to-r from-gray-800 to-gray-900 overflow-hidden p-4"> {/* Full width with padding */}
    {/* Main image */}
    <img
    ...
    <div className="absolute bottom-6 left-4 flex flex-col sm:flex-row items-end">
